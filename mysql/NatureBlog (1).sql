...
--
-- Host: localhost
-- Generation Time: May 26, 2020 at 05:46 PM
...
INSERT INTO `comments` (`id`, `articleID`, `author`, `nickname`, `comment`, `email`, `pubdate`) VALUES
(1, 3, 'Kirill', 'Roller', 'The average dog is a nicer person than the average person.', 'jojo@gmail.com', '2020-05-26 15:42:33'),
(2, 2, 'Volodia', 'Baller', 'It would be nice to spend billions on schools and roads, but right now that money is desperately needed for political ads.', 'jer@gmail.com', '2020-05-26 15:42:33'),
(3, 5, 'Jhon', 'Doe', 'At every party there are two kinds of people – those who want to go home and those who don’t. The trouble is, they are usually married to each other.', 'fufu@gmail.com', '2020-05-26 15:42:33'),
(4, 3, 'Daniel', 'PuhPHP', 'If you want your children to listen, try talking softly to someone else.', 'puh@gmail.com', '2020-05-26 15:42:33'),
(5, 4, 'George', 'Hohms', 'Doctors are just the same as lawyers; the only difference is that lawyers merely rob you, whereas doctors rob you and kill you too.', 'hoha@gmail.com', '2020-05-26 15:42:33'),
(6, 1, 'Siri', 'Slick', 'Trouble knocked at the door, but, hearing laughter, hurried away.', 'siri@gmail.com', '2020-05-26 15:42:33'),
(7, 4, 'Katrina', 'Honey', 'Be who you are and say what you feel, because those who mind don’t matter and those who matter don’t mind.', 'honnnn@gmail.com', '2020-05-26 15:42:33');
